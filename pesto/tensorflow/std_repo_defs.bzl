...
load("@bzl_rules_closure//closure/private:java_import_external.bzl",
     "java_import_external")
load("@bzl_rules_closure//closure:defs.bzl", "filegroup_external")
load(
...
load(
    "//third_party/keras_applications_archive:workspace.bzl",
    keras_applications="repo")
...
def create_std_tf_repos(path_prefix="", tf_repo_name=""):
    ...
    mkl_repository(
        ...
        build_file=clean_dep("//third_party/mkl:mkl.BUILD"),
        sha256=
        "411a30014a938eb83fb9f37b3dbe8e371b106fc1dd621fc23123cadc72737ce6",
    ...
    if path_prefix:
        print(
            "path_prefix was specified to tf_workspace but is no longer used "
    ...
    tf_http_archive(
        ...
        sha256=
        "b100f57af4a2b59a3a37a1ba38f77b644d2107d758a1a7f4e51310063cd21e73",
    ...
    tf_http_archive(
        ...
        sha256=
        "970285762565c7890c6c087d262b0a18286e7d0384f13a37786d8521773bc969",
        strip_prefix=
        "tools-0e906ebc527eab1cdbf7adabff5b474da9562e9f/arm-bcm2708/arm-rpi-4.9.3-linux-gnueabihf",
        urls=[
    ...
    tf_http_archive(
        ...
        sha256=
        "cd8532021352b4a0290d209f7f9bfd7c2411e08286a893af3577a43457287bfa",
    ...
    tf_http_archive(
        ...
        sha256=
        "6560547c63e4af82b0f202cb710ceabb3f21347a4b996db565a411da5b17aba0",
    ...
    tf_http_archive(
        name="absl_py",
        sha256=
        "95160f778a62c7a60ddeadc7bf2d83f85a23a27359814aca12cf949e896fa82c",
    ...
    tf_http_archive(
        name="nsync",
        sha256=
        "692f9b30e219f71a6371b98edd39cef3cbda35ac3abc4cd99ce19db430a5591a",
    ...
    tf_http_archive(
        ...
        sha256=
        "353ab86e35cea1cd386115279cf4b16695bbf21b897bfbf2721cf4cb5f64ade8",
    ...
    tf_http_archive(
        ...
        sha256=
        "69acbc2fbdefb955d42a4c606dfde800c2885711d2979e356c0636efde9ec3b5",
    ...
    tf_http_archive(
        ...
        sha256=
        "7f51f45887a3d31b4ce4fa5965210a5e64637ceac12720cfce7954d6a2e812f7",
    ...
    tf_http_archive(
        ...
        sha256=
        "286465fc41ade5c1c44e4a6dce9681106664fcdd12264dc9be63fc22bbee3c9c",
    ...
    tf_http_archive(
        name="boringssl",
        sha256=
        "1188e29000013ed6517168600fc35a010d58c5d321846d6a6dfee74e4c788b45",
    ...
    tf_http_archive(
        ...
        sha256=
        "19132b5127fa8e02d95a09795866923f04064c8f1e0770b2b42ab551408882a4",
    ...
    tf_http_archive(
        ...
        sha256=
        "cc6ebbcd0a826eec1b8ce1f625ffe71b53ef3290f8192b6cae38412a958f4fd3",
    ...
    tf_http_archive(
        ...
        sha256=
        "e0928ca4aa10ea1e0551e2d7ce4d1d7ea2d84b2abbdef082b0da84268791d0c4",
    ...
    tf_http_archive(
        ...
        sha256=
        "07dfbe80638eb1fe681f7c07e61b34b579c6710c691e49ee90ccdc6e9e75ebbb",
        strip_prefix=
        "bazel-toolchains-9a111bd82161c1fbe8ed17a593ca1023fd941c70",
        urls=[
    ...
    tf_http_archive(
        ...
        sha256=
        "2f7fbffac0d98d201ad0586f686034371a6d152ca67508ab611adc2386ad30de",
        strip_prefix=
        "double-conversion-3992066a95b823efc8ccc1baf82a1cfc73f6e9b8",
        system_build_file=clean_dep(
    ...
    tf_http_archive(
        ...
        sha256=
        "8980151b85a87a9c1a3bb1ed4748119e4a85abd3cb5744d83da4d4bd0fbeef7c",
        urls=[
    ...
    tf_http_archive(
        ...
        sha256=
        "21288dccc517acee47fa9648d4d3da28bf0fef5381911ed7b4d2ee36366ffa20",
        strip_prefix="ovic",
        urls=[
    ...
    tf_http_archive(
        ...
        sha256=
        "2b28f9c9f063b96825a96d56d7f7978c9a1c55c9b25175c20dd49a8a77cb0305",
    ...
    tf_http_archive(
        ...
        sha256=
        "89accbc702e68a09775f1011a99dd16561038fd1ce59d566d64450176abaae5c",
